...
# Personal autonomous percentage of exposure
A1 <- 0
A2 <- 0
A0 <- 1-A1-A2
...
# Commercial aut pct of exposure
A1 <- 0
A2 <- 0
A0 <- 1-A1-A2
...
NO_AV <- model.2(time.frame = time.frame[1:(length(time.frame)-1)], autocar = autocar, glm.list = glm$rd, 
