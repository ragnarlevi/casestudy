...
freq.pct$A1 <- data.frame(time = t, 
                          NC_BI.pct = 0.05*(1-carb.personal.pct$A0) + 0.5*carb.personal.pct$A0, 
                          NC_PD.pct = 0.05*(1-carb.personal.pct$A0) + 0.5*carb.personal.pct$A0,
                          NC_COM.pct = rep(1, length(t)), 
                          NC_COL.pct = 0.05*(1-carb.personal.pct$A0) + 0.5*carb.personal.pct$A0,
                          NC_PI.pct = 0.05*(1-carb.personal.pct$A0) + 0.5*carb.personal.pct$A0)

freq.pct$A2 <- data.frame(time = t, 
                          NC_BI.pct = 0.025*(1-carb.personal.pct$A0) + 0.25*carb.personal.pct$A0, 
                          NC_PD.pct = 0.025*(1-carb.personal.pct$A0) + 0.25*carb.personal.pct$A0, 
                          NC_COM.pct = rep(1, length(t)), 
                          NC_COL.pct = 0.025*(1-carb.personal.pct$A0) + 0.25*carb.personal.pct$A0, 
                          NC_PI.pct = 0.025*(1-carb.personal.pct$A0) + 0.25*carb.personal.pct$A0)
...
predict.df.zero <- predict.df[predict.df$Exposure == 0, ]
 predict.df <- predict.df[predict.df$Exposure != 0, ]
  ...
  tmp <- aggregate(formula = . ~ time , data = tmp, FUN = mean)
  tmp.melt <- melt(data = tmp, id = c("time"))
